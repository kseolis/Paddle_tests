...
class NodeTest {
    ...
    @Nested
    class CompileScript {
        private final String INITIAL_SCRIPT = fromFile("ride_scripts/wallet.ride");
        private final String ERROR_SCRIPT = fromFile("ride_scripts/wallet.ride").replace("i.payment", "v.payment");
